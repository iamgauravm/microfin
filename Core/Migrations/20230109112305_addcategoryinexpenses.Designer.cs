...
namespace MicroFIN.Core.Migrations
{
    ...
    [Migration("20230109112305_addcategoryinexpenses")]
    partial class addcategoryinexpenses
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MicroFIN.Core.Entities.Agent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Mobile = "7974165346",
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2023, 1, 9, 16, 53, 5, 187, DateTimeKind.Local).AddTicks(9450),
            ...
            modelBuilder.Entity("MicroFIN.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2023, 1, 9, 16, 53, 5, 187, DateTimeKind.Local).AddTicks(9264),
                            Name = "System Admin",
                            Password = "sysadmin",
                            Role = "sysadmin",
                            Username = "sysadmin"
                        ...
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2023, 1, 9, 16, 53, 5, 187, DateTimeKind.Local).AddTicks(9285),
                            Name = "Admin",
                            Password = "admin",
                            Role = "admin",
                            Username = "admin"
                        ...
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2023, 1, 9, 16, 53, 5, 187, DateTimeKind.Local).AddTicks(9289),
                            Name = "User",
                            Password = "user",
                            Role = "user",
                            Username = "user"
