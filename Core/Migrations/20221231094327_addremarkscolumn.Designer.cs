...
namespace MicroFIN.Core.Migrations
{
    ...
    [Migration("20221231094327_addremarkscolumn")]
    partial class addremarkscolumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MicroFIN.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2022, 12, 31, 15, 13, 27, 362, DateTimeKind.Local).AddTicks(9637),
                            Name = "System Admin",
                            Password = "sysadmin",
                            Role = "sysadmin",
                            Username = "sysadmin"
                        ...
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2022, 12, 31, 15, 13, 27, 362, DateTimeKind.Local).AddTicks(9651),
                            Name = "Admin",
                            Password = "admin",
                            Role = "admin",
                            Username = "admin"
                        ...
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2022, 12, 31, 15, 13, 27, 362, DateTimeKind.Local).AddTicks(9653),
                            Name = "User",
                            Password = "user",
                            Role = "user",
                            Username = "user"
