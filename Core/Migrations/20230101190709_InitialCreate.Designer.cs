...
namespace MicroFIN.Core.Migrations
{
    ...
    [Migration("20230101190709_InitialCreate")]
            ...
            modelBuilder.Entity("MicroFIN.Core.Entities.Agent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Mobile = "7974165346",
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2023, 1, 2, 0, 37, 9, 281, DateTimeKind.Local).AddTicks(298),
            ...
            modelBuilder.Entity("MicroFIN.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2023, 1, 2, 0, 37, 9, 281, DateTimeKind.Local).AddTicks(113),
                            Name = "System Admin",
                            Password = "sysadmin",
                            Role = "sysadmin",
                            Username = "sysadmin"
                        ...
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2023, 1, 2, 0, 37, 9, 281, DateTimeKind.Local).AddTicks(126),
                            Name = "Admin",
                            Password = "admin",
                            Role = "admin",
                            Username = "admin"
                        ...
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2023, 1, 2, 0, 37, 9, 281, DateTimeKind.Local).AddTicks(162),
                            Name = "User",
                            Password = "user",
                            Role = "user",
                            Username = "user"
