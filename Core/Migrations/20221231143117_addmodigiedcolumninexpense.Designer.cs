...
namespace MicroFIN.Core.Migrations
{
    ...
    [Migration("20221231143117_addmodigiedcolumninexpense")]
    partial class addmodigiedcolumninexpense
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MicroFIN.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2022, 12, 31, 20, 1, 17, 29, DateTimeKind.Local).AddTicks(6123),
                            Name = "System Admin",
                            Password = "sysadmin",
                            Role = "sysadmin",
                            Username = "sysadmin"
                        ...
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2022, 12, 31, 20, 1, 17, 29, DateTimeKind.Local).AddTicks(6135),
                            Name = "Admin",
                            Password = "admin",
                            Role = "admin",
                            Username = "admin"
                        ...
                        new
                        {
                            ...
                            IsActice = true,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2022, 12, 31, 20, 1, 17, 29, DateTimeKind.Local).AddTicks(6137),
                            Name = "User",
                            Password = "user",
                            Role = "user",
                            Username = "user"
